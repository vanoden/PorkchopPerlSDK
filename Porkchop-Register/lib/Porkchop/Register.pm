#######################################################
### Porkchop::Register								###
### Interfaces with Porkchop::Register module API.	###
...
# This allows declaration	use Porkchop::Register ':all';
...
sub new
{
	...
	$self->{config} = {
		'protocol'		=> 'http',
		'path'			=> '',
		'user-agent'	=> 'Porkchop::Register/'.$VERSION,
	};
